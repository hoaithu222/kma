...
const DetailLecturer = () => {
  ...
  const { getDetailLecturerDispatch, statusGetDetailLecturer, detailLecturer } =
    useLecturer();

  useEffect(() => {
    if (id) {
      getDetailLecturerDispatch(Number(id));
    }
  }, [id]);
  ...
  return (
    <div className="mt-10 min-h-screen rounded-lg sm:mt-14 md:mt-20 lg:mt-28">
