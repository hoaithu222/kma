...
export const getCourseCategory = (
  ...
  if (
    ...
    name.includes("signal processing") ||
    name.includes("data transmission") ||
    name.includes("telecommunications") ||
    name.includes("mobile information") ||
