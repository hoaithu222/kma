  ...
  return (
    <div className="relative group">
      ...
      <div className="relative overflow-hidden border-0 shadow-lg sm:shadow-xl bg-background-surface rounded-xl sm:rounded-2xl backdrop-blur-sm">
        ...
        {/* Content */}
        {isExpanded && (
          <div className="p-2 xs:p-3 sm:p-4 md:p-6 bg-gradient-to-br from-gray-50 to-blue-50/30">
            {/* Regular courses */}
            ...
            {semesterData.secureSoftwareTechnology && (
              <div className="mt-3 xs:mt-4 sm:mt-6 md:mt-8">
                <div className="p-1 border-0 border-l-4 border-blue-500 rounded-lg shadow-md md:p-2 lg:p-3 sm:rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100">
                  <h4 className="flex items-center mb-2 text-sm font-bold text-blue-800 xs:mb-3 xs:text-base sm:mb-4 sm:text-lg">
                    <div className="p-1.5 xs:p-2 mr-2 xs:mr-3 rounded-lg bg-blue-500/20">
                      <Code className="w-3.5 h-3.5 xs:w-4 xs:h-4 text-blue-600 sm:w-5 sm:h-5" />
                    </div>
