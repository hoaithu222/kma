  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-background-subtle via-background-base to-background-surface">
      ...
      <div className="relative">
        ...
        {/* Inner Ring */}
        <div
          className="absolute border-4 border-transparent rounded-full inset-2 border-t-secondary border-r-primary animate-spin"
          style={{ animationDirection: "reverse", animationDuration: "1s" }}
        ></div>

        {/* Center Icon */}
        <div
          className={`${sizeClasses[size]} relative flex items-center justify-center bg-gradient-to-br from-secondary to-primary rounded-full text-white shadow-lg`}
        >
      ...
      <div className="flex mt-8 space-x-4">
        ...
        <div
          className="flex items-center justify-center w-10 h-10 text-white rounded-full bg-gradient-to-r from-primary to-primary-dark animate-bounce"
      ...
      <div className="mt-6 text-center">
        <h2 className="mb-2 text-xl font-bold text-transparent bg-gradient-to-r from-secondary to-primary bg-clip-text">
