  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] py-12">
      ...
      <div className="relative">
        ...
        <div
          className="absolute w-16 h-16 border-4 border-transparent rounded-full top-2 left-2 border-t-secondary border-r-primary animate-spin"
      ...
      <div className="flex mt-8 space-x-6">
        ...
        >
          <div className="flex items-center justify-center w-8 h-8 transition-colors bg-background-muted rounded-lg hover:bg-background-subtle">
      ...
      <div className="w-48 h-1 mt-4 overflow-hidden bg-background-muted rounded-full">
        <div className="h-full rounded-full bg-gradient-to-r from-secondary to-primary animate-pulse"></div>
      </div>
    </div>
  );
};
