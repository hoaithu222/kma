...
const AchievementTimeline = ({
  ...
  return (
    <div className="p-2 border shadow-lg md:p-6 lg:p-8 bg-gradient-to-br from-warning/5 to-accent/5 rounded-xl md:rounded-2xl border-warning/20">
      ...
      <div className="space-y-3 md:space-y-4 lg:space-y-6">
        {achievements.map((achievement, index) => (
          <div
            key={index}
            className="group relative bg-background-elevated rounded-xl p-1 sm:p-3 md:p-4 lg:p-6 shadow-md border-l-2 md:border-l-3 lg:border-l-4 border-warning hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
          >
            <div className="flex items-start gap-2 md:gap-3 lg:gap-4">
              <div className="sm:flex-shrink-0 p-1 sm:p-2 md:p-2.5 lg:p-3 rounded-full bg-warning/10 ">
                <Award className="w-4 h-4 text-warning md:w-5 md:h-5 lg:w-6 lg:h-6" />
              </div>
